    ...
    <div className='login-settings'>
      ...
      <div className='change-login-information-container'>
          <form className="login-container-right-input" onSubmit={handleSubmit}>
            <div className='yourlogin' id='yourlogin'></div>
            <input type="login" placeholder='Your login' className='input' name='username' onChange={(e) => setUsername(e.target.value)} value={username1}/>
